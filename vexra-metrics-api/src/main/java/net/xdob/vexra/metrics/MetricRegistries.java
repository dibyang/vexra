...
public abstract class MetricRegistries {
   ...
   */
  public abstract VexraMetricRegistry create(MetricRegistryInfo info);
   ...
   */
  public abstract Optional<VexraMetricRegistry> get(MetricRegistryInfo info);
   ...
   */
  public abstract Collection<VexraMetricRegistry> getMetricRegistries();
   ...
   */
  public abstract void addReporterRegistration(Consumer<VexraMetricRegistry> reporterRegistration,
