...
public final class AutoCloseableLock implements AutoCloseable {
  ...
  public static AutoCloseableLock tryAcquire(final Lock lock, long timeout, TimeUnit unit) throws InterruptedException, LockTimeoutException {
    return tryAcquire(lock, null, timeout, unit);
  }

  public static AutoCloseableLock tryAcquire(final Lock lock, Runnable preUnlock, long timeout, TimeUnit unit) throws InterruptedException, LockTimeoutException {
