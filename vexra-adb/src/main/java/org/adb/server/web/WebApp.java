...
import org.adb.bnf.Bnf;
import org.adb.bnf.context.DbColumn;
import org.adb.bnf.context.DbContents;
import org.adb.bnf.context.DbSchema;
import org.adb.bnf.context.DbTableOrView;
import org.adb.command.Parser;
import org.adb.engine.Constants;
import org.adb.engine.SysProperties;
import org.adb.jdbc.JdbcException;
import org.adb.message.DbException;
import org.adb.security.SHA256;
import org.adb.tools.Backup;
import org.adb.tools.ChangeFileEncryption;
import org.adb.tools.ConvertTraceFile;
import org.adb.tools.CreateCluster;
import org.adb.tools.DeleteDbFiles;
import org.adb.tools.Recover;
import org.adb.tools.Restore;
import org.adb.tools.RunScript;
import org.adb.tools.Script;
import org.adb.tools.SimpleResultSet;
import org.adb.util.JdbcUtils;
import org.adb.util.NetUtils;
import org.adb.util.NetworkConnectionInfo;
import org.adb.util.Profiler;
import org.adb.util.ScriptReader;
import org.adb.util.SortedProperties;
import org.adb.util.StringUtils;
import org.adb.util.Tool;
import org.adb.util.Utils;
import org.adb.util.Utils10;
...
public class WebApp {
    ...
    private static String linkToSource(String s) {
        try {
            ...
            while (true) {
                int start = s.indexOf("org.adb.", idx);
                if (start < 0) {
