 ...
 */
package org.adb.util.geometry;

import static org.adb.util.geometry.GeometryUtils.DIMENSION_SYSTEM_XYM;
import static org.adb.util.geometry.GeometryUtils.DIMENSION_SYSTEM_XYZ;
import static org.adb.util.geometry.GeometryUtils.GEOMETRY_COLLECTION;
import static org.adb.util.geometry.GeometryUtils.LINE_STRING;
import static org.adb.util.geometry.GeometryUtils.M;
import static org.adb.util.geometry.GeometryUtils.MULTI_LINE_STRING;
import static org.adb.util.geometry.GeometryUtils.MULTI_POINT;
import static org.adb.util.geometry.GeometryUtils.MULTI_POLYGON;
import static org.adb.util.geometry.GeometryUtils.POINT;
import static org.adb.util.geometry.GeometryUtils.POLYGON;
import static org.adb.util.geometry.GeometryUtils.X;
import static org.adb.util.geometry.GeometryUtils.Y;
import static org.adb.util.geometry.GeometryUtils.Z;
...
import org.adb.util.geometry.EWKBUtils.EWKBTarget;
import org.adb.util.geometry.GeometryUtils.DimensionSystemTarget;
import org.adb.util.geometry.GeometryUtils.Target;
import org.adb.util.json.JSONArray;
import org.adb.util.json.JSONByteArrayTarget;
import org.adb.util.json.JSONBytesSource;
import org.adb.util.json.JSONNull;
import org.adb.util.json.JSONNumber;
import org.adb.util.json.JSONObject;
import org.adb.util.json.JSONString;
import org.adb.util.json.JSONValue;
import org.adb.util.json.JSONValueTarget;
