...
import org.adb.store.fs.disk.FilePathDisk;
...
public abstract class FilePath {
    ...
    static {
        ...
        for (String c : new String[] {
                "org.adb.store.fs.mem.FilePathMem",
                "org.adb.store.fs.mem.FilePathMemLZF",
                "org.adb.store.fs.niomem.FilePathNioMem",
                "org.adb.store.fs.niomem.FilePathNioMemLZF",
                "org.adb.store.fs.split.FilePathSplit",
                "org.adb.store.fs.niomapped.FilePathNioMapped",
                "org.adb.store.fs.async.FilePathAsync",
                "org.adb.store.fs.zip.FilePathZip",
                "org.adb.store.fs.retry.FilePathRetryOnInterrupt"
        }) {
            try {
