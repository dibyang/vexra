...
import static org.adb.result.SortOrder.DESCENDING;
import static org.adb.result.SortOrder.NULLS_FIRST;
import static org.adb.result.SortOrder.NULLS_LAST;
...
public enum DefaultNullOrdering {
    ...
    /**
     * Returns a sort type bit mask with {@link org.adb.result.SortOrder#NULLS_FIRST} or
     * {@link org.adb.result.SortOrder#NULLS_LAST} explicitly set
     *
     * @param sortType
     *            sort type bit mask
     * @return bit mask with {@link org.adb.result.SortOrder#NULLS_FIRST} or {@link org.adb.result.SortOrder#NULLS_LAST}
     *         explicitly set
     */
