 ...
 */
package org.adb.message;

import static org.adb.api.ErrorCode.*;
...
import org.adb.jdbc.JdbcSQLDataException;
import org.adb.jdbc.JdbcSQLException;
import org.adb.jdbc.JdbcSQLFeatureNotSupportedException;
import org.adb.jdbc.JdbcSQLIntegrityConstraintViolationException;
import org.adb.jdbc.JdbcSQLInvalidAuthorizationSpecException;
import org.adb.jdbc.JdbcSQLNonTransientConnectionException;
import org.adb.jdbc.JdbcSQLNonTransientException;
import org.adb.jdbc.JdbcSQLSyntaxErrorException;
import org.adb.jdbc.JdbcSQLTimeoutException;
import org.adb.jdbc.JdbcSQLTransactionRollbackException;
import org.adb.jdbc.JdbcSQLTransientException;
...
public class DbException extends RuntimeException {
    ...
    static {
        try {
            byte[] messages = Utils.getResource("/org.adb/res/_messages_en.prop");
            if (messages != null) {
            ...
            if (!"en".equals(language)) {
                byte[] translations = Utils.getResource(
                        "/org.adb/res/_messages_" + language + ".prop");
