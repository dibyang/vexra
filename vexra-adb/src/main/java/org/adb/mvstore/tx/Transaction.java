...
public final class Transaction {
  ...
  public TxnMap2 getTxnMap2() {
    return txnMap2;
  }

  public void setTxnMap2(TxnMap2 txnMap2) {
    this.txnMap2 = txnMap2;
  }
  ...
  public void rollbackToSavepoint(long savepointId) {
    ...
    try {
      ...
      if(txnMap2!=null){
        txnMap2.rollbackTo(savepointId);
      }
    } finally {
