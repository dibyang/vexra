...
import org.adb.mvstore.MVMap.Decision;
...
class TxDecisionMaker<K,V> extends MVMap.DecisionMaker<VersionedValue<V>> {
     ...
     * {@link org.adb.mvstore.MVMap.Decision#REPEAT}.
     */
     ...
     * {@link org.adb.mvstore.MVMap.Decision#PUT} decision along with last known
     * committed value
     *
     * @param valueToLog previous value to be logged
     * @param lastValue last known committed value
     * @return {@link org.adb.mvstore.MVMap.Decision#PUT}
     */
