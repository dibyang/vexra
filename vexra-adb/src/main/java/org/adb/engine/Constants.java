...
public class Constants {
    ...
    /**
     * The default port number of the HTTP server (for the ADB Console).
     ...
     */
    public static final String START_URL = "jdbc:adb:";
     ...
     */
    public static final String USER_PACKAGE = "org.adb.dynamic";
