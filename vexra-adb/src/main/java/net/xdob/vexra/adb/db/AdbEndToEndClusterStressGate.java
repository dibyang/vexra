 ...
 * region 的读写 smoke、commit 崩溃注入、kill/restart 恢复演练和滚动升级演练必须全部通过，
 * 并且至少有一次 SQL/region smoke 循环。</p>
 */
public final class AdbEndToEndClusterStressGate {
  ...
  public AdbLongRunStressEvaluation evaluate(
    ...
    reasons.addAll(report.getRecoveryDrillEvaluation().getFailureReasons());
