...
- Later GA-06 work still needs to wire the SQL diagnostics recorder into h2db plugin listeners or JDBC/Server hooks, and design live runtime connection parameters for `adb-doctor`.
