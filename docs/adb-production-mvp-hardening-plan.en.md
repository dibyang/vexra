...
- This increment covers node heartbeat records, region snapshots, route epoch, route watch, control-plane TTL write protection, and monotonic TSO. Leases, replicated control-plane service, and system-table provider remain later GA-03 subtasks.
