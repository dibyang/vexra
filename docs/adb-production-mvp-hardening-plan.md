...
- 本增量已覆盖节点心跳记录、region 快照、route epoch、route watch、控制面 TTL 写入保护、单调 TSO，以及 nodes/regions/tso 的 `AdbSystemTableProvider` 输出；租约、多副本控制面、leases/capabilities 系统表仍保留在后续 GA-03 子任务。
