...
public final class Slices {
  ...
  public static Slice encodeLong(long v) {
    byte[] array = ByteBuffer.allocate(8)
  ...
  public static Optional<Long> decodeLong(Slice slice) {
    return decodeLong(slice.getBytes());
  }

  public static Slice utf8Slice(String s) {
    return wrappedBuffer(s.getBytes(java.nio.charset.StandardCharsets.UTF_8));
  }
