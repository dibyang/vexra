...
import net.xdob.vexra.protocol.exceptions.ReconfigurationTimeoutException;
import net.xdob.vexra.server.*;
import net.xdob.vexra.server.config.RaftServerConfigKeys;
import net.xdob.vexra.server.impl.ReadIndexHeartbeats.AppendEntriesListener;
...
import net.xdob.vexra.server.metrics.LogAppenderMetrics;
...
import static net.xdob.vexra.server.config.RaftServerConfigKeys.Write.FOLLOWER_GAP_RATIO_MAX_KEY;
...
class LeaderStateImpl implements LeaderState {
  ...
  public boolean isReady() {
		return isInitialized() && startupLogEntry.get().isApplied();
  }
