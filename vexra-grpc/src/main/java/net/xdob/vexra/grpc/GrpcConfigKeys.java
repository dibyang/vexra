...
import static net.xdob.vexra.conf.ConfUtils.get;
import static net.xdob.vexra.conf.ConfUtils.getBoolean;
import static net.xdob.vexra.conf.ConfUtils.getInt;
import static net.xdob.vexra.conf.ConfUtils.getSizeInBytes;
import static net.xdob.vexra.conf.ConfUtils.getTimeDuration;
import static net.xdob.vexra.conf.ConfUtils.printAll;
import static net.xdob.vexra.conf.ConfUtils.requireMax;
import static net.xdob.vexra.conf.ConfUtils.requireMin;
import static net.xdob.vexra.conf.ConfUtils.set;
import static net.xdob.vexra.conf.ConfUtils.setBoolean;
import static net.xdob.vexra.conf.ConfUtils.setInt;
import static net.xdob.vexra.conf.ConfUtils.setSizeInBytes;
import static net.xdob.vexra.conf.ConfUtils.setTimeDuration;
