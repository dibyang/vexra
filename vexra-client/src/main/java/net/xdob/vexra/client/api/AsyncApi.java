...
public interface AsyncApi {
  ...
  CompletableFuture<RaftClientReply> sendUnordered(Message message, ReplicationLevel replication);
  ...
  default CompletableFuture<RaftClientReply> sendUnordered(Message message) {
    return sendUnordered(message, ReplicationLevel.MAJORITY);
  }
  ...
  default CompletableFuture<RaftClientReply> sendAdmin(Message message) {
   ...
   * @return a future of the reply.
   */
  CompletableFuture<RaftClientReply> sendAdmin(Message message, RaftPeerId server);
}
